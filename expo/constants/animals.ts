...
export const ANIMALS: AnimalWithAbility[] = [
  { id: 'lion', name: 'Lion', biome: 'savanna', hp: 52, atk: 18, def: 8, spd: 12, funFact: "A lion's roar can be heard from 5 miles away.", catchTip: 'Weaken below half HP before bonding.', ability: { name: 'Apex Roar', description: 'Reduces enemy ATK by 5 for 2 turns', effect: 'ink', value: 5, unlockLevel: 3 }, rivalId: 'hyena', synergyId: 'cheetah' },
  ...
  { id: 'dolphin', name: 'Dolphin', biome: 'ocean', hp: 42, atk: 16, def: 6, spd: 18, funFact: 'Dolphins sleep with one eye open.', catchTip: 'Quick and light. Easy to weaken.', ability: { name: 'Sonar Burst', description: 'Reduces enemy SPD by 6 for 2 turns', effect: 'ink', value: 6, unlockLevel: 3 }, rivalId: 'shark', synergyId: 'orca' },
  ...
  { id: 'gorilla', name: 'Gorilla', biome: 'jungle', hp: 75, atk: 20, def: 12, spd: 8, funFact: 'Gorillas share 98% of DNA with humans.', catchTip: 'High HP tank. Wear it down patiently.', ability: { name: 'Chest Beat', description: 'ATK +6 and reduces enemy DEF by 4', effect: 'rage', value: 6, unlockLevel: 3 }, rivalId: 'jaguar' },
